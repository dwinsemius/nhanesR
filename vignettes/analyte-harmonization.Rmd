...
The analysis tracks eight biomarkers across the eight NHANES cycles from
2003–2018 that contain linked mortality follow-up and GGT measurements
(the nine previous cycles, 1999–2002, lack GGT in the standard biochemistry
panel):

| Analyte | Primary variable | Known complication |
|---|---|---|
| GGT | LBXSGTSI | Consistent across all 8 cycles |
| ALT | LBXSATSI | Consistent across all 8 cycles |
| Total cholesterol | LBXTC | Consistent |
| Albumin | LBXSAL | Consistent |
| AST | LBXSASSI | **Missing from 2007–2008** |
| ALP | LBXSAPSI / LBDSAPSI | **Prefix changes; missing 4 of 8 cycles** |
| Total bilirubin | LBXSTB | Consistent |
| Serum creatinine | LBXSCR | Consistent |
| Liver disease (ever) | MCQ160L / MCQ160l | **Case changes at 2011–2012** |
| Liver disease (current) | MCQ170L / MCQ170l | **Case changes at 2011–2012** |
...
attempt to merge PTH with ALP (available in 2003–2004, 2013–2014, 2015–2016,
and 2017–2018) will yield a single-cycle overlap (2003–2004) — a constraint
